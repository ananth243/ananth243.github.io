...
function Contact() {
  ...
  function formSubmit(e) {
    e.preventDefault();
    axios.post("https://ananth243.herokuapp.com/", {
      name,
      email,
      message,
    })
      ...
      >
        <div className="flex flex-col" style={{ width: "45%" }}>
          <p className="text-center">
            I'm available for any paid gigs and always am open to learn new
            things and from my mistakes. Here are my socials if you want to
            reach me from here
          </p>
